                  ...
                  <tr key={idx}>
                    ...
                    <td className='border px-2 py-1 border-gray-300 dark:border-gray-700'>
                      <input
                        ...
                        min={0}
                        onChange={e =>
                          handleEditItemChange(idx, 'orderItemPrice', Number(e.target.value))
                        }
                        required
                      />
                    </td>
                    <td className='border px-2 py-1 border-gray-300 dark:border-gray-700'>
                      <input
                        ...
                        min={1}
                        onChange={e =>
                          handleEditItemChange(idx, 'orderItemQuantity', Number(e.target.value))
                        }
                        required
                      />
                    </td>
                    <td className='border px-2 py-1 border-gray-300 dark:border-gray-700 text-center'>
                      {item.orderItemQuantity
                        ? (item.orderItemPrice / item.orderItemQuantity).toFixed(2)
                        : '0.00'}
                    </td>
                    <td className='border px-2 py-1 border-gray-300 dark:border-gray-700 text-center'>
                      <button
