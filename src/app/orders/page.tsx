...
export default function OrdersPage() {
    const { db, collection, doc: getDocRef, getDoc, user, userRoles, loading: authLoading } = useAuth();
    ...
    useEffect(() => {
        async function checkNavPermission() {
            ...
            try {
                ...
                const ordersNav = data.items?.find((item: NavPermissionItem) => item.id === 'orders');
                ...
                const hasAccess = userRoles.some(role => 
                    ordersNav.defaultRoles.includes(role)
                );
        ...
        checkNavPermission();
    }, [user, userRoles, authLoading, db, getDoc]);
