...
export default function ContractsPage() {
    ...
    const rows = useMemo(() => {
        ...
        const sortFns: Record<string, (a: Record<string, unknown>, b: Record<string, unknown>) => number> = {
            ...
            contractName: (a, b) => (a.contractName as string || "").localeCompare(b.contractName as string || ""),
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="bg-gray-50 dark:bg-gray-700/50">
                                    ...
                                    <th className="px-4 py-3 text-left font-medium text-gray-500 dark:text-gray-400 cursor-pointer" onClick={() => handleSort("contractName")}>
                                    ...
                                    <th className="px-4 py-3 text-left font-medium text-gray-500 dark:text-gray-400 cursor-pointer" onClick={() => handleSort("contractPrice")}>
                            ...
                            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                {loading ? (
                                    ...
                                    rows.map((row) => {
                                        ...
                                        return (
                                            <tr key={row.contractId as string} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200">
                                                <td className="px-4 py-3 text-gray-900 dark:text-gray-100">{row.idx as number}</td>
                                                <td className="px-4 py-3 text-gray-900 dark:text-gray-100">{row.contractName as string}</td>
                                                <td className="px-4 py-3 text-gray-900 dark:text-gray-100">{row.clientName as string}</td>
                                                <td className="px-4 py-3 text-gray-900 dark:text-gray-100">{row.contractPrice as number}</td>
                                    ...
                                    <tr><td colSpan={8} className="px-4 py-8 text-center text-gray-500 dark:text-gray-400">尚無合約</td></tr>
                                )}
                            </tbody>
                        </table>
                    </div>
