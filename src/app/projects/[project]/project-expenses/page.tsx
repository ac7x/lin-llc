...
export default function ProjectExpensesPage() {
  ...
  const handleAddExpenseItem = () => {
    if (
      ...
      newExpenseItem.quantity === 0 ||
      newExpenseItem.unitPrice === 0
    ) {
  ...
  const handleRemoveExpenseItem = (itemId: string) => {
    setNewExpense(prev => {
      ...
      return {
        ...prev,
        items: items
          .filter(item => item.expenseItemId !== itemId)
          .map(item => ({
            ...item,
            updatedAt: now,
          })),
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  ...
                  <input
                    ...
                    value={
                      newExpense.expenseDate
                        ? formatDateForInput(newExpense.expenseDate)
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e =>
                      setNewExpense({ ...newExpense, type: e.target.value as '請款' | '支出' })
                    }
                    required
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e =>
                      setNewExpense({
                        ...newExpense,
                        status: e.target.value as 'draft' | 'issued' | 'cancelled',
                      })
                    }
                    required
                  >
                    ...
                    >
                      <div className='flex-1'>
                        ...
                        <div className='text-sm text-gray-500 dark:text-gray-400'>
                          數量: {item.quantity} × NT$ {item.unitPrice.toLocaleString()} = NT${' '}
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                    <div>
                      ...
                      <input
                        ...
                        onChange={e =>
                          setNewExpenseItem({ ...newExpenseItem, description: e.target.value })
                        }
                      />
                    </div>
                    <div>
