                ...
                if (input.workpackageId && input.subWorkpackageId && input.actualQuantity > 0) {
                    ...
                    if (wp) {
                        ...
                        if (sw) {
                            ...
                            const percent = sw.estimatedQuantity ? Math.round((newActualQuantity / sw.estimatedQuantity) * 100) : 0;
                            sw.progress = percent;
                                ...
                                <div className="flex-grow">
                                    ...
                                    {input.subWorkpackageId && selectedSubWp && (
                                        <div className="mt-1 text-xs text-gray-600 dark:text-gray-400">
                                            <span>累計: {selectedSubWp.actualQuantity || 0} / 應完成: {selectedSubWp.estimatedQuantity ?? '-'}</span>
                                        </div>
                                    )}
                                </div>
