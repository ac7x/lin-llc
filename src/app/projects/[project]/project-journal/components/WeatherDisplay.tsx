...
export default function WeatherDisplay({ weatherData, loading, error, className = "" }: WeatherDisplayProps) {
    ...
    if (loading) {
        return (
            <div className={`inline-flex items-center px-4 py-2 bg-gray-50 dark:bg-gray-700 text-gray-500 dark:text-gray-400 rounded-lg ${className}`}>
    ...
    return (
        <div className={`inline-flex items-center px-4 py-2 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-lg ${className}`}>
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
