...
export default function TemplatesPage() {
  ...
  const categories = ['水電', '清潔', '沐運', '測試', '維護', '其他'];
  const units = [
    '項',
    '個',
    '塊',
                    ...
                    <table className='w-full border-collapse'>
                      <thead>
                        <tr className='bg-gray-50 dark:bg-gray-900'>
                          <th className='px-4 py-2 text-left text-sm font-medium text-gray-600 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700'>
                            名稱
                          </th>
                          <th className='px-4 py-2 text-left text-sm font-medium text-gray-600 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700'>
                            描述
