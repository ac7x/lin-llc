...
import { DragConnectHandler } from "./DragConnectHandler";
...
function DecompositionFlow(props: any) {
    ...
    return (
        <div style={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
            <DeleteButton onDelete={deleteSelected} disabled={selectedNodes.length === 0 && selectedEdges.length === 0} />
            ...
            {rfNodes.length === 0 && rfEdges.length === 0 ? (
                ...
                <div style={{ flex: 1 }} ref={reactFlowWrapper}>
                    ...
                    >
                        {({
                            onConnectStart: dragHandlerOnConnectStart,
                            onConnectEnd: dragHandlerOnConnectEnd,
                            onNodeDragStop,
                        }) => (
                            <ReactFlow
                                nodes={rfNodes}
